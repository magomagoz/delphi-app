...
<p style="margin:0; font-size: 16px; text-transform: uppercase; opacity: 0.9;">🎯 **Fiducia nel pronostico**</p>
...
<p style="margin:0; font-size: 16px; text-transform: uppercase; opacity: 0.9;">📊 **Affidabilità dei Dati**</p>
